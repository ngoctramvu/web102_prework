        ...
        element.innerHTML = `
            <div class="game-card-inner">
                <div class="game-card-front">
                    <img class="game-img" src="${game.img}" alt="game"/>
                    <h3>${game.name}</h3>
                </div>
                <div class="game-card-back">
                    ...
                    <div class="game-card-stats">
                        ...
                        <p>Raised: $${game.pledged.toLocaleString('en-US')} | Backers: ${game.backers.toLocaleString('en-US')}</p>
                    </div>
                </div>
            </div>
        `
...
const displayStr = 
    ...
    Currently, ${numUnfunded > 1 ? numUnfunded + ' games remain' : '1 game remains'} unfunded.
